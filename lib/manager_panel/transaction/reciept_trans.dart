...
class ReceiptTrans extends StatefulWidget {
  const ReceiptTrans({super.key});

  @override
  State<ReceiptTrans> createState() => _ReceiptTransState();
}

class _ReceiptTransState extends State<ReceiptTrans> {
  @override
