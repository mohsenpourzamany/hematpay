...
import 'package:hematpay/manager_panel/transaction/reciept_trans.dart';
import 'package:hematpay/user_account/notification_user.dart';

class ConfirmCashTrans extends StatefulWidget {
  const ConfirmCashTrans({super.key});

  @override
  State<ConfirmCashTrans> createState() => _ConfirmCashTransState();
}

class _ConfirmCashTransState extends State<ConfirmCashTrans> {
